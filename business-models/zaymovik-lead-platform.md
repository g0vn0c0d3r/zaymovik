...
- **МФО-партнёр** — микрофинансовая организация, которая оценивает клиента, принимает решение, заключает договор и выдаёт деньги.
...
Новый сайт или CPA-оффер подключается к единому приёму заявок, а новая МФО — к балансировщику. Поэтому количество офферов и МФО можно увеличивать независимо друг от друга без перестройки всей схемы.
