...
6. Прошедшая порог заявка поступает в балансировщик. Он формирует пул доступных МФО: партнёр должен быть активен, его интеграция должна работать, лимит заявок не должен быть исчерпан, а **ликвидность** — возможность выдавать деньги сейчас — должна быть доступна.
...
![Вертикальная схема CPA-модели Zaymovik](./zaymovik-cpa-scoring-flow.svg)
